...
func setup_timer():
	...
	timer_label.position = Vector2(get_viewport_rect().size.x - 110, 20)
	...
	timer_bg.position = Vector2(get_viewport_rect().size.x - 110, 20)
	timer_bg.color = Color(0.2, 0.2, 0.2, 0.0)
